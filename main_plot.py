...
if(0): # plot for Human Activity
    ...
    plot_summary_human_activity_eta(num_users=numusers, loc_ep1=local_ep, Numb_Glob_Iters=num_glob_iters, lamb=L_k,
                               learning_rate=learning_rate, robust = robust, algorithms_list=algorithms, batch_size=batch_size, dataset=dataset, k = K, personal_learning_rate = personal_learning_rate)
